...
//    "" != null;
    ...
    void setFrom(int row) {
        ...
        rdoNu.setSelected(tblDSNguoiHoc.getValueAt(row, 2).toString() == "false" ? true : false);
        rdoNam.setSelected(tblDSNguoiHoc.getValueAt(row, 2).toString() == "true" ? true : false);
    ...
    NguoiHoc getFrom() throws Exception {
        NguoiHoc nh = new NguoiHoc();
