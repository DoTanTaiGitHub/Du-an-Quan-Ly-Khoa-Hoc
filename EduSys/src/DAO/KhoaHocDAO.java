...
public class KhoaHocDAO extends EduSysDao<KhoaHoc, String> {
    ...
    try {
            XJdbc.update(INSERT_SQL,
                    entity.getMaCD(),entity.getHocPhi(),entity.getThoiLuong(),entity.getNgayKG().toString(),
                    entity.getGhiChu(),entity.getMaNV(), entity.getNgayTao().toString());
    ...
    public void update(KhoaHoc entity) {
        try {
            XJdbc.update(UPDATE_SQL,
                    entity.getMaCD(),entity.getHocPhi(),entity.getThoiLuong(),entity.getNgayKG().toString(),
                    entity.getGhiChu(),entity.getMaNV(),entity.getNgayTao().toString(),entity.getMaKH());        
        }   catch (SQLException ex) {
            Logger.getLogger(ChuyenDeDAO.class.getName()).log(Level.SEVERE, null, ex);
            }    
    }
